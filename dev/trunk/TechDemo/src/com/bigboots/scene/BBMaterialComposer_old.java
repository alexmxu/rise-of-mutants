 ...
 * @author mifth
 */
public class BBMaterialComposer_old {
    ...
    public BBMaterialComposer_old (Geometry geom_mc, String dirBase, String dirLevel, AssetManager assetManager, boolean BlenderOrOgre) {
        asset = assetManager;    
        geo = geom_mc;
